...
void datacollect::DataCollector::HAL_ADC_ConvCpltCallback(ADC_HandleTypeDef *hadc)
{
...
uint16_t datacollect::DataCollector::Get_voltage_cap()
{
    return V_CAP_ADC; 
}
uint16_t datacollect::DataCollector::Get_current_cap()
{
    return I_CAP_ADC; 
}